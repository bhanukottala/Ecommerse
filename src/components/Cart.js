            ...
            {shoppingCart.length > 0 ? <div className="cart-summary">
                <div className="summary">
                    ...
                    <div className="total-price-section">
                        <div className="just-titel">Total Price</div>
                        <div className="items-price">${totalPrice}.00</div>
                    </div>
                    <div className="stripe-section">
                        <StripeCheckout
                        stripeKey="pk_test_51IOPdQGABCuuyWdU4LQIzoQPiaWaMEHeU7rwvhylCvHqldFCSI070idznIoR92PinD1xYCGLElHDJ7mssLrH4Vrk00J2V1NhO0"
                        token={handleToken}
                        billingAddress
                        shippingAddress
